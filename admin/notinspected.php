      ...
      <div class="row">
          ...
          <div class="">  
              <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">              
                <li class="nav-item" role="presentation">
                  <button class="nav-link active" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button"  role="tab" aria-controls="pills-profile" aria-selected="true">List of not inspected vehicles</button>
                </li>
                <li class="nav-item" role="presentation">
                  <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#pills-contact" type="button"   role="tab" aria-controls="pills-contact" aria-selected="false">vehicles that passed their due date</button>
                </li>
              </ul>
            </div>
        <div class='tab-content pt-2' id='myTabContent'>
              ...
              <thead>
                ...
                <?php                  
                     $comp = $_SESSION['company'];       
                     $sql ="SELECT * from vehicle ORDER BY driver ASC";
                       $result = $conn1->query($sql);
                       ...
                       while($row = $result->fetch_assoc()) {
                         $pl = $row["plateno"];  
                  $sql1="SELECT plateno,inspection_date from inspection WHERE catagory = '".$_SESSION['cata']."' AND plateno = '$pl' ";
                      $result1 = $conn->query($sql1);
                         if($result1->num_rows == 0){                            
                    ?>   
                 <tr>
                 <td style ="color:#012970; "data-label="Driver"><?php echo $row['driver'];?></td>
                <td  style ="color:#012970;" data-label="Plate Number" style="width=30px;"><?php echo $row['plateno'];?></td>
                <td style ="color:#012970;"  data-label="Vehicle Model"><?php echo $row["model"];?></td>                           
                <td style ="color:#012970;" data-label="Company"><?php echo $row['company'];?></td>                                
                <td style ="color:#012970;" data-label="type" ><?php echo $row['type'];?></td>
                <?php   $datee=date('d');
                    if($datee >= 3){             
                    ?>        
                <td style ="color:#012970;"  data-label="Inspect vehicle" ><a href='insp_form.php?asset=<?php echo $_SESSION['cata'];?>&pn=<?php echo $pl ;?>' class='btn btn-primary btn-sm '>Inspect</a></td>
                <?php }else{?>
                  <td style ="color:#012970;"  data-label="Inspect vehicle" ><a href='insp_form.php?asset=<?php echo $_SESSION['cata'];?>&pn=<?php echo $pl;?>' class='btn btn-primary btn-sm'>Inspect</a></td>
                  </tr><?php }?>               
