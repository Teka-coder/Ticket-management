...
<body>
 ...
 <main id="main" class="main">
  <div class="card">
     ...
     <div class="pagetitle">
     <br>
     <h1 class="decorated"><span>Instock records<span></h1> 
         </div>
...
$tot_sql="select count(*) as c from tickets where soldout_status=?;";
  ...
  ?>
      ...
      <div class="card-header  text-center p-0 card-header bg-dark">
           <h5 class="card-title text-white">Instock List</h5>
          </div>
           <div class="card-body">
