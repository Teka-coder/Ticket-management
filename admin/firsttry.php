...
<form method="POST" action="bodystructure.php?asset=<?php echo $cata;?>&pn=<?php echo $ppn;?>">
        <div class="col-md-12">
        <div class="row">               
        <div class="col-md-6">  
        <div class="camera"  id="my_camera"></div>
        <button type="submit" id="camera--trigger" class="btn">Take Snapshot</button>
         <input type="hidden" id="camera--output" name="image" class="image-tag">      
        <a href="bodystructure.php?asset=<?php echo $cata;?>&pn=<?php echo $ppn;?>" id="continue" class="btn d-none" >Continue</a>
