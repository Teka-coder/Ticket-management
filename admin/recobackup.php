...
///////////////////////////////////for exterior body inspection/////////////////////////////////////  
  if(isset($_POST['bsubmit'])){
   ...
   VALUES('$cata','".$model."','".$plateno."','".$inspection_date."','".$nxt_insp_date."','".$_SESSION['int_okay']."',
                 '".$_SESSION['int_notokay']."','".$_SESSION['ex_okay']."','".$_SESSION['ex_notokay']."','".$_SESSION['int_not_available']."','".$_SESSION['ext_not_available']."','".$_SESSION['username']."','".$driver."','".$_SESSION['prev_odometer_reading']."','".$_SESSION['curr_odometer_reading']."','". $_SESSION['serviced_at_odo']."','".$company."','".$_SESSION['comment']."','".$_SESSION['inspectiontype']."')";
...
//set gmail password
$mail->Password = "mpGxKiZwvH~d";
//set email subject
$date=date("Y-m-d");
$mail->IsHTML(true);

$mail->Subject = "Issue Report on vehicle number $ppn for date $date";
//set sender email
...
//add recipient
$recipients = array(
   'gashu.wendawke@dz-fi.com' => 'Gashu Wendawke',
   //'gashu.wendawke@magcoffee.com' => 'Gashu Wendawke one',
   //'mahlet.nigussie@hagbes.com' => 'Mahlet Nigussie',
   // ..
);
...
//Add CC
//$mail->AddCC("gashualemu@gmail.com");
