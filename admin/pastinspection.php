...
<body>
 ...
 <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <?php if(isset($_SESSION['kmbs'])){  ?>      
        <li class="breadcrumb-item"><a href="inspection_rec.php?asset=<?php echo $cata;?>&pn=<?php echo $pnn;?>&date=<?php echo $date;?>"><i class="fa fa-arrow-circle-o-left" style="font-size:36px;color:#87CEEB"></i></a></li>            
      <?php }else{?>
         <li class="breadcrumb-item"><a href="inspreport.php?asset=<?php echo $cata;?>"><i class="fa fa-arrow-circle-o-left" style="font-size:36px;color:#87CEEB"></i></a></li>     
    <?php  }?>
      </ol>
      </nav>
    </div>
     ...
     <div class="card">
            ...
            <div class="card-body">                       
              ...
              <div class='tab-pane fade show active' id='pills-profile' role='tabpanel' aria-labelledby='profile-tab'>
                           ...
                           <h6 span class='badge bg-success text-light'>Compliant Items</span><h6>
                    <div class="row">
                           <?php 
                      ...
                      <div class="col-sm-3"> 
                          ...
                          <?php  }  ?> 
                           ...
                           <h6  span class='badge bg-danger text-light'>Non-Compliant  Items</span><h6>
                           <div class="row">                       
                         <?php 
                           $arr=explode(',',$row['int_notokay']);                        
                           foreach($arr as $na){?>
                     <div class="col-sm-2">
                         <br><span class='' ><?php echo $na?></span><br>
                     </div>
                          <?php }
                        ?>                      
                    </div>
                    <h6 span class='badge bg-info text-light'>Items that doesn't exist on the vehicle</span><h6>
                    <div class="row">
                           <?php 
                           $arr=explode(',',$row['int_not_available']);                         
                           foreach($arr as $naa){?>
                      <div class="col-sm-3"> 
                          <br><span class=''><?php echo $naa?></span><br>
                      </div>
                          <?php  }  ?> 
                ...
                <div class='tab-pane fade' id='pills-contact' role='tabpanel' aria-labelledby='contact-tab'>                    
                           ...
                           <div class="row"> 
                          <?php 
                           $ex_okay=explode(',',$row['ex_okay']);
                           foreach($ex_okay as $e){?>
                           <div class="col-sm-3"> 
                        ...
                        <h6 span class='badge bg-danger text-light'>Non-Compliant Items</span><h6>
                           <div class="row"> 
                          <?php 
                           $ex_noto=explode(',',$row['ex_notokay']);
                           foreach($ex_noto as $ena){?>
                           <div class="col-sm-3"> 
                         <br> <span class=''><?php echo $ena?></span><br>
                           </div>
                          <?php  }
                        ?>
                        </div>                      
                        <h6 span class='badge bg-info text-light'>Items that doesn't exist on the vehicle<h6>
                        <div class="row"> 
                          <?php 
                           $ex_not=explode(',',$row['ex_not_available']);
    ...
    <table class="table table-image">
      ...
      <?php 
        ...
        <tr>
          ...
          <!--added a max-height-->
               <img src="<?php echo $row['image'] ?>" class="img-fluid img-thumbnail" alt="" style="max-height:500px;" >
               </a> 
          </td>
