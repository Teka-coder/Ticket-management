...
<?php
$val='checkedin'; 
 $stmt= "SELECT * from tickets WHERE checkin_status=? ORDER BY checkin_time DESC";
$tot_sql="select count(*) as c from tickets where checkin_status=?;";
  ...
  ?>
      ...
      <div class="card-header  text-center p-0 card-header bg-dark">
           <h5 class="card-title text-white">Check-In List</h5>
          </div>
           <div class="card-body">
             ...
             <table class="table table-bordered border-primary">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a class="badge bg-dark" href='<?php echo "../tickets/audition-record.php?all_type1=".$rec["id"];?>'>
