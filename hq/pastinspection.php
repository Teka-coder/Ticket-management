...
<body>
 ...
 <div class="pagetitle">
      ...
      <nav>
        ...
        <li class="breadcrumb-item"><a href="inspection_rec.php?asset=<?php echo $cata;?>&pn=<?php echo $pnn;?>&date=<?php echo $date;?>&type=<?php echo $type;?>"><i class="fa fa-arrow-circle-o-left" style="font-size:36px;color:#87CEEB"></i></a></li>        
        <?php }
        else{?>
        <li class="breadcrumb-item"><a href="inspreport.php?asset=<?php echo $cata;?>&pn=<?php echo $pnn;?>&date=<?php echo $date;?>"><i class="fa fa-arrow-circle-o-left" style="font-size:36px;color:#87CEEB"></i></a></li>
        <?php  }?>
      </ol>
      </nav>
    </div>
