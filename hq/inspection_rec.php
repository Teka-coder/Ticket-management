  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle" style="text-align: center">
      <h1>Inspection and Maintenance records</h1>
       <nav>
        <ol class="breadcrumb">
          <li><a href="inde.php?asset=<?php echo $cata;?>&type=<?php echo $type;?>"><i class="fa fa-arrow-circle-o-left" style="font-size:36px;color:#87CEEB"></i></a></li>         
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section dashboard">
     <div class="row">
       <div class="col-lg-4 col-md-6">
              ...
              <div class="card info-card sales-card">
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    $test = "SELECT Max(nxt_inspection_date) as next FROM `inspection` WHERE plateno= '$pnn' AND catagory='$cata' AND inspection_type='$type'" ;
            ...
            <div class=" col-lg-4 col-md-6 mx-auto  me-0">
              <div class="card info-card revenue-card">
                                <?php
                     $test = "SELECT  MAX(serviced_at_odo) AS km,driver FROM inspection WHERE plateno = '$pnn'";
                    $result = $conn->query($test);  
                      if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()){  
                      $driver = $row['driver'];
        ...
        <div class="col-lg-6">
          ...
          <div class="card">
            ...
            <h5 class="text-white text-center" style="text-align:center">Monthly Inspection Record</h5>
              </div>
            <div class="card-body">            
                ...
                <tbody>
                  <tr>                  
                   ...
                   // $model= $_SESSION["plateno"];
                    ...
                    $sql = "SELECT * FROM `inspection` WHERE plateno='$pnn' AND inspection_type='$type' ";
                      ...
                      $iid = $row['id'];
                       echo
                         ...
                         <td>".$row['inspection_date']."</td>
                          <td>
                          <a href='pastinspection.php?id=$iid&asset=$cata&pn=$pnn&date=$date&type=$type' class='btn btn-outline-primary btn-sm' name='inspect".$row['inspection_date']."'>View Detail</a></td>
                          </tr>";
                         // <a href='rule.php?ppn=$pnn&kmr=$rkk' class='btn btn-primary'>Update</a>
       ...
       <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-header">
             <h5 class="text-white" style="text-align:center">Vehicle Maintenance History</h5>
                  </div>
             <div class="card-body">
