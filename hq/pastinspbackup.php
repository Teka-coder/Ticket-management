...
<div class="pagetitle">
     ...
     <div class="card">
            <div class="card-header">  <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation">
                  <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" onclick="document.getElementById('interior').classList.remove('d-none');document.getElementById('exterior').classList.remove('d-none')" role="tab" aria-controls="pills-home" aria-selected="true">Inspection Information</button>
                </li>
                <li class="nav-item" role="presentation">
                  <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" onclick="document.getElementById('exterior').classList.add('d-none');document.getElementById('interior').classList.remove('d-none')" role="tab" aria-controls="pills-profile" aria-selected="false">Internal Items</button>
                </li>
                <li class="nav-item" role="presentation">
            ...
            <div class="card-body">                       
                ...
                <div class='col-lg-12'>
                         <div class='row'>  
                <div class='col-lg-4'>
                      <p>Vehicle Model:<?php echo $row['model']?></p>
                      <p>Plate Number: <?php echo $row['plateno']?></p>
                  </div>
                  <div class='col-lg-4'>
                       <p>Inspection Date: <?php echo $row['inspection_date']?></p>
                        <p>Next Inspection Date:<?php echo $row['nxt_inspection_date']?></p>
                        </div>
                  <div class='col-lg-4'>     
                        <p>Inspected By: <?php echo $row['inspected_by']?></p>
   ...
   <div class="card" id="interior">
    <div class="card-header">interior body inspection</div>
      <div class="card-body">
   <div class="col-lg-12">
   <div class="row">                                          
     <?php 
          ...
          $query = "SELECT * from int_inspection where insp_id = '$id'";
           ...
           if ($res->num_rows > 0) {
            while($row = $res->fetch_assoc()){      
                ...
                <figure><figcaption style='text-align:center;'><i><?php echo ucfirst($row['name'])?></i></figcaption><img src="<?php echo $row['image'] ?>" class="img-fluid" alt="" ></figure>
               </a>                           
                 <h6 style ="color:#012970;">Status:&nbsp <?php echo $row['status'] ?></h6>
                 <h6 style ="color:#012970;">Damage Type:&nbsp<?php echo $row['damage_type'] ?></h6> 
                   </div>
                   </div>
                <?php
                 }
            ...
            <div class="card-header">Exterior body inspection</div>
            <div class="card-body">
   <div class="col-lg-12">
   <div class="row"> 
     <?php 
    ...
    $test = "SELECT * from ext_inspection where exinsp_id = '$id'";
     ...
     if ($result->num_rows > 0) {
      while($row = $result->fetch_assoc()){      
            ...
            <div class="col-md-4"> 
            <div class="gallery column">            
            <a  href="<?php echo $row['image'] ?>" size='lg' data-toggle="lightbox" data-caption="<?php echo $row['name'] ?>" data-gallery="example-gallery" >          
            <figure><figcaption style='text-align:center;'><i><?php echo ucfirst($row['name'])?></i></figcaption> <img src="<?php echo $row['image'] ?>" class="img-fluid" style="width:100%;" alt="" ></figure>
                  </a>
           <h6 style ="color:#012970;">Status:&nbsp <?php echo $row['status'] ?></h6>
           <h6 style ="color:#012970;" >Damage Type:&nbsp<?php echo $row['damage_status'] ?></h6> 
           </div>
    </div>
    <?php }
          }?>
