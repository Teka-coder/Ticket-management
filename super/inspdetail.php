...
<body>
 ...
 <div class="pagetitle">
    ...
    <div class="row">
              ...
              <button class='btn btn-info btn-sm'><i class='fa fa-save'></i>Save Changes</button>
              <button class='btn btn-danger btn-sm deletebtn' name='delete'><i class='bi bi-trash'></i>Delete Inspection</button>
    </div>
    </div>          
    <div class="col-lg-12">
      <div class="card">
