<?php 
session_start();
if($_SESSION['role']=="edit" || $_SESSION['role']=="admin" && isset($_SESSION['username']) && $_SESSION['username']!=''){
...
<body>
 ...
 $fetch="SELECT * from tickets WHERE id=? ORDER BY checkin_time DESC";
 ...
 $history=$com->get_result();
   ...
   <div class="card">
     ...
     <div class="pagetitle">
     <br>
     <h1 class="decorated"><span>Check-In Detail of Ticket: <?php echo "<b class='text-primary' >".ucfirst($iname)."</b>"; ?></span></h1> 
         </div>
 ...
 <div class='row' data-aos="zoom-in">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <li class="list-group-item d-flex justify-content-between align-items-start">
                    ...
                    } elseif ($record["checkin_status"] == 'checkedin') {
                        echo '<span class="badge bg-warning rounded-pill">Used-Up</span>';
                    } elseif ($record["checkin_status"] == 'notset') {
                ...
                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 pb-2">
                <p class="card-text"><b>Status: </b><r style="text-align: left;"><?php echo $record["checkin_status"] ?></r></p>
                    <p class="card-text"><b>Ticket ID: </b><r style="text-align: left;"><?php echo $record["ticket_unique_id"] ?></r></p>
                    <p class="card-text"><b>Verified by: </b><r style="text-align: left;"><?php echo $record["verified_by"] ?></r></p>
                    <p class="card-text"><b>Remark: </b><r style="text-align: left;"><?php echo $record["checkin_remark"] ?></r></p>
                    
                    <li class="list-group-item d-flex justify-content-between align-items-start">
                        <div class="ms-2 me-auto">
                            <div class="fw-bold"> <i class="card-text">As of: <i><?php echo date("M d, Y H:i:s", strtotime($record["checkin_time"])) ?></i></i></div>
                        </div>
  ...
  echo "<script>alert('Ticket with Id:".$_GET["all_type1"]." not found');
