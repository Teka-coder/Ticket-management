...
<?php
$val='checkedin'; 
 $stmt= "SELECT * from tickets WHERE checkin_status=? AND verified_by=? ORDER BY checkin_time DESC";
$tot_sql="select count(*) as c from tickets where checkin_status=? AND verified_by=?;";
